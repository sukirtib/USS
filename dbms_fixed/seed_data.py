...
Run: python seed_data.py  OR  python manage.py seed_data
"""
import os
import django
...
if User.objects.exists():
    ...
    if not User.objects.filter(username='trainer1').exists():
        ...
        print('Created trainer and courses')
    ...
    print('Done! Login: admin/admin123, student1/pass123, consultant1/pass123, trainer1/pass123')
