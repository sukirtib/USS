...
Based on the entity-relationship specification.
"""
...
class Course(models.Model):
    """Courses offered (IELTS, PTE, SAT, etc.)."""
...
class Batch(models.Model):
    """Scheduled batches for courses with trainer assignment."""
...
class CourseRegistration(models.Model):
    """Student applications for courses before enrollment."""
    class Status(models.TextChoices):
...
class Enrollment(models.Model):
    """Confirmed student enrollments converted from registrations."""
    class Status(models.TextChoices):
    ...
    def __str__(self):
        return f"{self.student} - {self.registration.course}"


class AppointmentBooking(models.Model):
    """Online counseling appointment requests and scheduling."""
    class Status(models.TextChoices):
        PENDING = 'PENDING', 'Pending'
        APPROVED = 'APPROVED', 'Approved'
        REJECTED = 'REJECTED', 'Rejected'
    ...
    def __str__(self):
        return f"{self.student} with {self.consultant} on {self.preferred_date}"


class Counseling(models.Model):
    """Counseling session records conducted after appointments."""
    appointment = models.OneToOneField(
        AppointmentBooking, on_delete=models.CASCADE, related_name='counseling_session'
    )
...
class MockTest(models.Model):
    ...
    def __str__(self):
        return f"{self.mock_test_name} ({self.course})"


class ExamRegistration(models.Model):
    """Student registrations for exams or mock tests."""
    class Status(models.TextChoices):
        PENDING = 'PENDING', 'Pending'
        APPROVED = 'APPROVED', 'Approved'
        REJECTED = 'REJECTED', 'Rejected'
    ...
    def __str__(self):
        return f"{self.student} - {self.course} exam on {self.exam_date}"


class Payment(models.Model):
    """Records financial transactions for courses, exams, or services."""
    ...
    def __str__(self):
        return f"{self.student} - {self.amount} ({self.purpose})"
